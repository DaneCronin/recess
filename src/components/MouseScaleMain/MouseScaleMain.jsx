  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.gallery}>
        ...
        <MouseScale projects={[projects[2], projects[3]]} reversed={true}/>
        <MouseScale projects={[projects[4], projects[5]]}/>
        <MouseScale projects={[projects[6], projects[7]]} reversed={true}/>e7hyhn
      </div>
    </main>
  )
}